...
[![My Skills](https://skillicons.dev/icons?i=androidstudio,dart,flutter,bash,c,cs,cpp,java,html,js,css,php,mysql,py,vscode,visualstudio)](https://skillicons.dev)\
